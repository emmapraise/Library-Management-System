                      ...
                      <div class="row">
                          <div class="col-md-12">
                              <div class="overview-wrap">
                                  <h2 class="title-1">Add Location List</h2>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">Location Category</h3>
                                        </div>
                                        <hr>
                                        <form action="loc_comit.php?" method="post">
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Location Name</label>
                                                <input id="cc-pament" autofocus='' name="loc_name" type="text" class="form-control" aria-required="true" aria-invalid="false"  value="" placeholder="Enter New Location Name">
                                            </div>
                                            <div class="">
