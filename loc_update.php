                      ...
                      <div class="row">
                          <div class="col-md-12">
                              <div class="overview-wrap">
                                  <h2 class="title-1">Update Location List</h2>
                                        ...
                                        <form action="loc_update_comit.php?action=<?php
                                          ...
                                          echo $_GET['id']; ?>" method="post">
                                            <div class="form-group">
                                                ...
                                                <input id="cc-pament" autofocus='' name="loc_name" type="text" class="form-control" aria-required="true" aria-invalid="false"  value="<?php echo $loc_name; ?>">
                                            </div>
                                            <div class="">
