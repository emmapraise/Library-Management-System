                      ...
                      <div class="row">
                          <div class="col-md-12">
                              <div class="overview-wrap">
                                  <h2 class="title-1">Book Lending</h2>
                                    ...
                                    <div class="card-body card-block">
                                      ...
                                      ?>
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <select name="loan_mem_name" id="selectLg" class="form-control form-control-lg">
                                      ...
                                      ?>
                                            ...
                                            <div class="form-group">
                                                <label for="street" class=" form-control-label">Loan Date</label>
