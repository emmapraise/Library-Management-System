                      ...
                      <div class="row">
                          <div class="col-md-12">
                              <div class="overview-wrap">
                                  <h2 class="title-1">Add New Book</h2>
                                    ...
                                    <div class="card-body card-block row">
                                      <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="snumber" class="form-control" name="slno" value="" placeholder="Enter The Serial Number" />
                                        </div>
                                        <div class="form-group">
                                            <label for="title" class=" form-control-label">Title</label>
                                            <input type="text" id="title"  class="form-control" name="title" value="" placeholder="Enter Title" />
                                        </div>
                                        <div class="form-group">
                                       ...
                                       while ($row=mysql_fetch_array($result)) {
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="publication"  class="form-control" name="publication" value="" placeholder="Enter Publication" />
                                        </div>

                                        <div class="form-group">
                                            <label for="edition" class=" form-control-label">Edition [ Ex: 5th edition ]</label>
                                            <input type="text" id="edition"  class="form-control" name="edition" value="" placeholder="Enter Edition" />
                                        </div>

                                        <div class="form-group">
                                            <label for="year" class=" form-control-label">Year of Publication</label>
                                            <input type="text" id="year"  class="form-control" name="year" value="" placeholder="Enter Year of Publication" />
                                        </div>
                                      </div>
                                      <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="pages" class=" form-control-label">Total Number of Pages</label>
                                            <input type="text" id="pages"  class="form-control" name="pages" value="" placeholder="Enter Total Number of Pages" />
                                        </div>

                                        <div class="form-group">
                                            <label for="total_holding" class=" form-control-label">Number of Books Available</label>
                                            <input type="text" id="total_holding"  class="form-control" name="total_holding" value="" placeholder="Enter number of Books Available" />
                                        </div>
                                      ...
                                      while ($row=mysql_fetch_array($result)) {
                                          $loc_name[$row['loc_id']]=$row['loc_name'];
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="related_name"  class="form-control" name="related_name" placeholder="Enter Related Name" value="" />
                                            </div>
                                        <div class="form-group">
                                                <label for="book_remark" class=" form-control-label">Comment</label>
                                                <textarea name="textarea-input" id="book_remark" rows="3" placeholder="Comment..." class="form-control" name="book_remark"></textarea>
                                        </div>
                                    </div>
                                  </div>
